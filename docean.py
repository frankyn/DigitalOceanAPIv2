...
class DOceanCLI:
    ...
    def __init__(self):
        ...
        # Droplet Delete based on a keyword
        parser.add_argument("--delete_with", type=str, default=False,
                            dest="delete_with", help="delete a droplet by keyword")
        ...
        elif args.delete_with:
            self.delete_with_handler(args)
    ...
    # Handle Delete with Droplet
    def delete_with_handler(self,args):
        # Get Droplets with specified keyword in name
        # Request droplet list
        information = self._docean.request_droplets()
        ...
        for droplet in information['droplets']:
            droplet_id = droplet['id']
            droplet_name = droplet['name']
            if droplet_name.find(args.delete_with) > -1:

                # Deleting the following
                print('Deleting %s'%(droplet_name))
                self._docean.request_delete(droplet_id)
